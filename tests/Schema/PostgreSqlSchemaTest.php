...
class PostgreSqlSchemaTest extends TestCase
{
    ...
    public function testCreateTable()
    {
        ...
        $expected = "CREATE TABLE test2 ( id SERIAL NOT NULL,user_id INTEGER(32) NOT NULL,content TEXT,status CHARACTER VARYING(255) NOT NULL DEFAULT 'good',CONSTRAINT fk_test2_user_id_users_id FOREIGN KEY ( user_id ) REFERENCES users ( id ),CONSTRAINT idx_test2_content_status UNIQUE ( content,status ),CONSTRAINT test2_pkey UNIQUE ( id ),PRIMARY KEY  ( id ) );";
